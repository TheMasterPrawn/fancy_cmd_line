<#
.SYNOPSIS
    Useful functions for your command line and some nice surprises
.DESCRIPTION
    Before you do anythiing , please install oh-my-posh from https://ohmyposh.dev/docs/installation/windows
.NOTES
    Store in $PROFILE.CurrentUserAllHosts
    Shout out to Tim Sneath who made all the stuff in here
.LINK
#>
...
{
    $themes = Get-ChildItem  "$env:POSH_THEMES_PATH"
    return Get-Random $themes.Name
}
...
if($randomiseThemes)
{
    $theme = Get-RandomTheme
    Write-Host "Theme is $theme" -ForegroundColor DarkBlue
